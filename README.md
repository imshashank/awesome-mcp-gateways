...
- [API.market](https://api.market/api/mcp/gateway) - Hosted Streamable HTTP gateway connecting AI agents to 580+ APIs through five discovery, execution, usage, and subscription tools, with OAuth or API-key authentication.
